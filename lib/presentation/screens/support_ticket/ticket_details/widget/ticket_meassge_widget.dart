  ...
  Widget build(BuildContext context) {
    return GetBuilder<TicketDetailsController>(
      builder: (controller) => CustomAppCard(
        showBorder: true,
        borderColor: messages.adminId == "1" ? MyColor.pendingColor : MyColor.borderColor,
        backgroundColor: messages.adminId == "1" ? MyColor.pendingColor.withValues(alpha: 0.1) : MyColor.getCardBgColor(),
        child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text(
                      DateConverter.getTimeAgo(messages.createdAt ?? ''),
